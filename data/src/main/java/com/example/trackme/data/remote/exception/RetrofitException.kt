package com.example.trackme.data.remote.exception

import com.example.trackme.data.remote.response.ServerErrorResponse
...
class RetrofitException(
    ...
    companion object {
        fun httpError(url: String, response: Response<*>?, retrofit: Retrofit): RetrofitException {
            val message = "${response?.code() ?: 0} ${response?.message() ?: ""}"
